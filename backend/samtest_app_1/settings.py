"""
Django settings for samtest_app_1 project.
...
ROOT_URLCONF = 'samtest_app_1.urls'
...
WSGI_APPLICATION = 'samtest_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "samtest_app_1 API",
    "DESCRIPTION": "API documentation for samtest_app_1 App",
    "VERSION": "v1",
}
